...
public class PlayerListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(this, LeaderboardContent.ITEMS, mTwoPane));
    }
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LeaderboardContent.DummyItem item = (LeaderboardContent.DummyItem) view.getTag();
                if (mTwoPane) {
                    Bundle arguments = new Bundle();
                    arguments.putString(PlayerDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(PlayerDetailFragment.ARG_ITEM_ID, item.id);
